...
GitHub Action that combines [Seqra](https://seqra.dev/) static analysis with [ZAP](https://www.zaproxy.org/) dynamic
...
- [example-full-scan.yml](.github/workflows/example-full-scan.yml) - Full scan for the main branch
